...
Все проектно-специфичные вещи живут в @namespace company::project {  }@. Соответственно содержимое больщинства файлов заворачивается в него. Namespace не создает дополнительного отступа.
